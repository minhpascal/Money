...
public class Bar {
	...
	public Tick tick() {
		...
		m_time += 5;  //Incoming bars happen every 5 seconds (supposedly).  Ticks want the end time, instead of the start time (from Bar)
		DateTime dt = new DateTime(m_time*1000);

		return new Tick(dt, m_open, m_high, m_low, m_close, m_volume);
	}
}
